...
public void OnPluginStart() 
{
	...
	g_cCTDefaultSkin = CreateConVar("sm_ct_skin", "", "Set a default skin for ct incase you don't want to use adminskins.ini");
	g_cTDefualtSkin = CreateConVar("sm_t_skin", "", "Set a default skin for t incase you don't want to use adminskins.ini");
	g_cCTDefaultArms = CreateConVar("sm_ct_arm", "", "Set a default skin for ct incase you don't want to use adminskins.ini");
	g_cTDefualtArms = CreateConVar("sm_t_arm", "", "Set a default skin for t incase you don't want to use adminskins.ini");
	
	//Delay Loading Database
	
	//Define Created Paths
	BuildPath(Path_SM, g_szFileSkinPath, 		sizeof(g_szFileSkinPath), 		"configs/playerskin/skins.ini");
	BuildPath(Path_SM, g_szFileAutoSkinPath, 	sizeof(g_szFileAutoSkinPath), 	"configs/playerskin/adminskins.ini");
